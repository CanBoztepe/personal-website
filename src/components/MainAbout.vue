<template>
  <p>
    ...
    under pressure and collaborate effectively in high-paced, team-oriented environments. I later
    transitioned into web development, learning JavaScript, HTML, and CSS, and landed an internship
